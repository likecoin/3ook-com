<template>
  ...
  >
    ...
    >
      <USkeleton class="bg-skeleton w-full aspect-2/3 rounded-lg" />
      ...
      <div class="mt-2 min-h-[3.2lh]">
        ...
        <div class="flex flex-col gap-1.5">
          <USkeleton class="bg-skeleton h-3.5 rounded" />
          <USkeleton class="bg-skeleton h-3.5 w-3/5 rounded" />
        </div>

        <div class="h-lh mt-[0.5lh]">
          <USkeleton class="bg-skeleton h-2.5 w-2/5 rounded" />
        </div>
      </div>

      <div class="flex items-center h-lh mt-[0.5lh]">
        <USkeleton class="bg-skeleton h-[0.8lh] w-1/3 rounded" />
      </div>
